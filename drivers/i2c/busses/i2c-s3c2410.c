...
static int s3c24xx_i2c_init(struct s3c24xx_i2c *i2c)
{
	...
	dev_err(i2c->dev, "[LIUYANG] [i2c-s3c2410.c] s3c24xx_i2c_init\n");
	pdata = s3c24xx_i2c_get_platformdata(i2c->adap.dev.parent);
	...
	dev_info(i2c->dev, "[LIUYANG][i2c-s3c2410.c]slave address 0x%02x\n", pdata->slave_addr);
...
static int s3c24xx_i2c_probe(struct platform_device *pdev)
{
	...
	dev_err(&pdev->dev, "[LIUYANG] [i2c-s3c2410.c] s3c24xx_i2c_probe\n");
...
//static int s3c24xx_i2c_xfer(struct i2c_adapter *adap, struct i2c_msg *msgs, int num)
	...
	s3c24xx_i2c_xfer(&i2c->adap, struct i2c_msg *msgs, int num)
